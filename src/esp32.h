...
#define EXP_I2CADDR_BASE 0x24 // base of expander I2C address
  ...
  #define ON_BOARD_GPIN_LIST_2   {21,22,23,25, 26,27,32,33} //  ESP32 on board gpins to be usead as sections, 255 - pin not defined
  #define PIN_FREE_LIST     {} // no free GPIO pin at the moment

  #define PIN_CURR_SENSE      39
  
  #define STATION_LOGIC  1 // GPIO logic ex. for relays conneted to grand 0 meens ON
